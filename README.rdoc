...
canonical_dude ist a small helper for Rails applications to make use of the Canonical URL Tag. Use it to se your
...
URL for that, too. Sometimes, you have even more of those cases with all different kinds of URLs. Being a good SEO Dude,
you can, of course, always exactly specify "canonical_url product_url(@product)" or you could have it always in one
place and just use "canonical_url @product" in all those controllers. All you need now is a helper could look like so:
  ...
  module CanonicalHelper
    ...
    # You can define the following methods for any class and canonical_dude will attempt for look for those in the
    # order of the given methosd below (taking our product example again):
